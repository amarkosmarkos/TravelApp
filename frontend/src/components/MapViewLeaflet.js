...
const MapViewLeaflet = ({ cities = [], selectedCityIndex = 0, onCitySelect }) => {
                        ...
                        <Box sx={{
                            ...
                            <Box sx={{
                                ...
                                <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                                    To implement a real map, install Leaflet:
                                </Typography>
                                <Box sx={{ 
                                    backgroundColor: '#f5f5f5', 
                                    p: 2, 
                                ...
                                <Typography variant="caption" color="text.secondary" sx={{ mt: 2, display: 'block' }}>
                                    Then import MapContainer and Marker from react-leaflet
                                </Typography>
                            </Box>

                            {/* City Markers (simulated) */}
